...
// //     FILE* csv_buffer = fopen("src/unit_testing/csv_testin_parocess_manager_parsing.csv", "r");
...
//     FILE* buffer = fopen("src/unit_testing/data_testing.csv", "r");
...
//     FILE* f = fopen("src/unit_testing/data_testing.csv", "r");
